...
from day05.main import count_number_of_nice, is_it_nice_redux
from main import is_it_nice, count_number_of_nice_redux


class Test(unittest.TestCase):

    def test_empty_string(self):
        self.assertEquals(False, is_it_nice(""))

    def test_nice_simple(self):
        self.assertEquals(True, is_it_nice("aaa"))

    def test_nice_complex(self):
        self.assertEquals(True, is_it_nice("ugknbfddgicrmopn"))

    def test_empty_naughty_no_double_letter(self):
        self.assertEquals(False, is_it_nice("jchzalrnumimnmhp"))

    def test_empty_naughty_forbidden_combo(self):
        self.assertEquals(False, is_it_nice("haegwjzuvuyypxyu"))

    def test_empty_naughty_lack_of_vowel(self):
        self.assertEquals(False, is_it_nice("dvszwmarrgswjxmb"))

    def test_answer(self):
        self.assertEquals(255, count_number_of_nice("""sszojmmrrkwuftyv
        isaljhemltsdzlum
        fujcyucsrxgatisb
        qiqqlmcgnhzparyg
        oijbmduquhfactbc
    ...
    def test_nice_simple_redux_fail(self):
        self.assertEquals(False, is_it_nice_redux("aaa"))
