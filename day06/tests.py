...
'''
import unittest
from day06.main import Decoration
...
class Test(unittest.TestCase):
    ...
    def test_input(self):
        self.decoration.process_instruction("turn on 0,0 through 1,1")
        self.assertEquals(
            4, self.decoration.sum_up_lights_on())
        self.decoration.process_instruction("turn off 0,0 through 1,1")
        self.assertEquals(
